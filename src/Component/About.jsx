...
import DrVandanaPic from '../assets/DrVandanaPic.jpg'
            ...
            <section id='about' className="text-gray-600 w-11/12 mx-auto mt-14 body-font">
                <div className="container mx-auto flex px-3 py- md:flex-row flex-col items-center">
                    <div className="pt-5 pb-0 md:w-96 w-5/6 ">
                        <img className=" object-cover object-center rounded-tl-3xl roundedxl border-l-8 border-red-200 w-96" alt="Dr Vandana Bansal Image" src={DrVandanaPic} />
                    </div>
