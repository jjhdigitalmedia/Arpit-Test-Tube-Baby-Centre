...
const VideoOfCentre = () => {
  ...
  return (
    <div className="flex justify-center my-10">
      <h3 className='px-10 hidden xl:block text-6xl font-bold text-white'>Arpit Test Tube Baby Centre</h3>
      <video
      ...
      <h3 className='px-10 hidden xl:block text-6xl font-bold text-rose-700'>Advanced Care with Cutting-Edge Equipment</h3>
    </div>
  );
};
