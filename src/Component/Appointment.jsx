...
const Appointment = () => {
  return (
    <div className="bg-gray-100 flex items-center flex-wrap md:px-16 py-10 w-full m-auto ">

      <div className="text-center md:text-left md:w-1/2 w-full md:py-10 px-2 md:px-10">
        <h1 className=' text-4xl text-centre md:text-left md:text-6xl mb-2 text-gray-600 font-bold font-asap md:mt-4'>Request an Appointment</h1>
      ...
      <div className="md:text-right md:w-1/2 w-full text-center my-8 px-4">
