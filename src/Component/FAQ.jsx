...
export function FAQ() {
    ...
    return (
        <>
            <h1 className="text-center font-medium my-10 text-5xl text-slate-700 font-asap mt-10 ">Frequently Asked Questions</h1>
            <div className=" text-center m-auto rounded-3xl faq" >
                {qna.map((ind, k) => (
                    <Accordion key={k} className="text-justify px-4 hover:bg-zinc-50" data-aos='fade-up' open={open === ind.i} icon={<Icon id={ind.i} open={open} />}>
